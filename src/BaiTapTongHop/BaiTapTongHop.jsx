...
export default function BaiTapTongHop() {
    ...
    return (
        ...
        <div className="grid grid-cols-6">
            ...
            <div className="h-full p-3 space-y-2 col-span-1  bg-coolGray-900 text-coolGray-100">
                ...
                <div className="divide-y divide-coolGray-700">
                    <ul className="pt-2 pb-4 space-y-1 text-sm">
                        {mangDanhMuc.map((danhMuc, index) => {
                            ...
                            return <li key={index} onClick={() => { setMaDanhMuc(danhMuc.maDanhMuc) }}>
            ...
            <div className='col-span-5 '>
                <h2 className="text-center text-purple-500 text-8xl mt-5 ">Menu</h2>
                        ...
                        <div className="flex flex-wrap -m-4">
                            {_.filter(data, item => item.maDanhMuc === maDanhMuc).map((item, index) => {
                                return <div className="p-4 lg:w-1/3" key={index}>
                                    <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative shadow-sm">
                                        ...
                                        <div className="leading-relaxed mb-3"><img className="rounded-lg shadow-lg   shadow-cyan-500/50" src={item.hinhAnh} alt="" /></div>
                                        <a className="text-indigo-500 inline-flex items-center" onClick={() => {
                                            setOpenModal(true);
                                            setItem({
